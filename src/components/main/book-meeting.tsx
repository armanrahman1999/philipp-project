  ...
  return (
    <section className="px-5 pb-8 text-center md:px-5 md:pb-10">
      ...
      <a
        ...
        className="mx-auto inline-block rounded-lg bg-teal-700 px-6 py-3.5 font-semibold text-white shadow-teal-button transition-colors hover:bg-teal-800 md:px-7 md:py-4"
      >
